        ...
        <div className="flex justify-between items-center w-full h-full px-4 2xl:px-16 py-5">
          ...
          <div>
            <ul className="hidden md:flex items-center">
              <li className="border-b border-transparent ml-10 hover:underline text-white text-xl ">
              ...
              <li className="border-b border-transparent ml-10 hover:underline text-white text-xl ">
                <button
                  className="bg-white border-white border rounded-2xl text-black hover:border-2 py-1 px-3"
                  onClick={closeNav}
                >
